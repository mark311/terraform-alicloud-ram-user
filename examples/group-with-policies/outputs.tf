output "this_group_users" {
  ...
  value       = module.ram-group-with-policies-example.this_group_users
}

output "this_group_name" {
  description = "RAM group name"
  value       = module.ram-group-with-policies-example.this_group_name
}
...
output "this_ram_self_management_policy_name" {
  ...
  value       = module.ram-group-with-policies-example.this_ram_self_management_policy_name
}

output "this_ram_self_management_policy_description" {
  description = "Description of ram_self_management policy"
  value       = module.ram-group-with-policies-example.this_ram_self_management_policy_description
}

# RAM custom policies
output "this_custom_policy_name" {
  description = "RAM custom name"
  value       = module.ram-group-with-policies-example.this_custom_policy_name
}

output "this_custom_description" {
  description = "Description of custom policy"
  value       = module.ram-group-with-policies-example.this_custom_description
}
