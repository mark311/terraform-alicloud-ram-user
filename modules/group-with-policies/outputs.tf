...
output "this_group_name" {
  ...
  value       = element(concat(alicloud_ram_group.this.*.name, [""]), 0)
}
...
output "this_ram_self_management_policy_name" {
  ...
  value       = alicloud_ram_policy.ram_self_management.*.policy_name
}
...
output "this_custom_policy_name" {
  ...
  value       = alicloud_ram_policy.custom.*.policy_name
}
